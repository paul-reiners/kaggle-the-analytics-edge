...
# Current AUC = 0.6908775

# Your submission scored 0.67166, which is not an improvement of your best score. 
# Keep trying!
...
model3 = lm(Happy ~ HouseholdStatus + Q122769 + Q122771 + Q119334 + Q115899 + Q113992 + Q107869 + Q102674 + Q101162 + Q98869, data=train)
summary(model3)
...
write.csv(submission, "./submissions/LinearRegressionSomeVars.csv", row.names=FALSE) 
